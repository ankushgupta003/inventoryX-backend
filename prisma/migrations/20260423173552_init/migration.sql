...
-- CreateEnum
CREATE TYPE "AccountType" AS ENUM ('SUPER_ADMIN', 'COMPANY_ADMIN', 'COMPANY_USER');
...
-- CreateIndex
CREATE INDEX "RolePermission_companyId_module_action_idx" ON "RolePermission"("companyId", "module", "action");
